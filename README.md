...
## JSON Binding Rules
The purpose of [this document](https://github.com/mojaloop/mojaloop-specification/blob/master/fspiop-api/documents/JSON%20Binding%20Rules.md) is to express the data model used by **the API** in the form of JSON Schema binding rules, along with validation rules for the corresponding instances.
...
## PKI Best Practices
[This document](https://github.com/mojaloop/mojaloop-specification/blob/master/fspiop-api/documents/PKI%20Best%20Practices.md) explains Public Key Infrastructure (PKI)  best practices to apply in **the API** deployment. See Chapter 2, PKI Background, for more information about PKI. 
