...
3. [API Signature Definition](#3-api-signature-definition)

    3.1 [Signature Data Model](#31-signature-data-model)

    3.2 [Generating a Signature](#32-generating-a-signature)

    3.3 [Validating Signature](#33-validating-signature)

4. [API Signature Examples](#4-api-signature-examples)

    4.1 [Generating a Signature](#41-generating-a-signature)

    4.2 [Validating Signature](#42-validating-signature)

5. [References](#5-references)

**Table of Tables**

[Table 1 – Data model of HTTP header field FSPIOP-Signature](#table-1)
