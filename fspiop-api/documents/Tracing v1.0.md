...
This document details the Distributed Tracing standards to be supported for Open APIs for Interoperability to ensure _tracing_ and _observability_ within the API system, and to/from API consumers.
